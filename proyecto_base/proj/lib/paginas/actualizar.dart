...
class _ActualizarState extends State<Actualizar> {
  ...
  Widget construirNombre(nombre, apellidos, email, telefono) => Column(
        children: [
          TextFormField(textAlign: TextAlign.center, initialValue: nombre + " " + apellidos, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
          const SizedBox(height: 4),
          TextFormField(textAlign: TextAlign.center, initialValue: email, style: const TextStyle(color: Colors.grey, fontSize: 18)),
          const SizedBox(height: 20),
          TextFormField(textAlign: TextAlign.center, initialValue: telefono, style: const TextStyle(color: Colors.grey, fontSize: 18)),
          const SizedBox(height: 20),
          Container(
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              iconSize: 50,
              items: ['DESEMPLEADO', 'CON EMPLEO'].map<DropdownMenuItem<String>>((String value) {
          ...
          Wrap(
            ...
            children: interesesSeleccionados.map((interest) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  color: seleccionado ? const Color.fromRGBO(25, 5, 255, 1) : Colors.grey[700],
                  borderRadius: BorderRadius.circular(20.0),
                ),
                child: Text(
                  interest.nombre,
