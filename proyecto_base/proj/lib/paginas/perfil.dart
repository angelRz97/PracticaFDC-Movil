...
class _PerfilState extends State<Perfil> {
  final nombreController = TextEditingController(text: Controlador.usuario.nombre);
  final apellidosController = TextEditingController(text: Controlador.usuario.apellidos);
  final emailController = TextEditingController(text: Controlador.usuario.email);
  final telefonoController = TextEditingController(text: Controlador.usuario.telefono);
    ...
    if (Controlador.usuario.email == "admin") {
      ...
      return ListView(
        ...
        children: [
          ...
          construirNombre(Controlador.usuario.nombre, Controlador.usuario.apellidos, Controlador.usuario.email, Controlador.usuario.telefono),
        ],
      );
    }
  }
        ...
        children: [
          ...
          SizedBox(
              ...
              child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF0750d8), side: BorderSide.none, shape: const StadiumBorder()),
                  child: const Text(
                    'Editar Perfil',
          ...
          Container(
            ...
            decoration: const BoxDecoration(color: Color.fromRGBO(25, 5, 255, 1), borderRadius: BorderRadius.all(Radius.circular(50))),
            child: const Text(
              'ESTADO',
              style: TextStyle(
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              icon: const Icon(Icons.arrow_drop_down, color: Color.fromRGBO(25, 5, 255, 1)),
              iconSize: 50,
              items: [Estado.DESEMPLEADO.name, Estado.EMPLEADO.name].map<DropdownMenuItem<String>>((String value) {
          ...
          Container(
              ...
              child: TextField(
                ...
                decoration:
                    InputDecoration(prefixIcon: const Icon(Icons.search), contentPadding: const EdgeInsets.symmetric(vertical: 8), border: OutlineInputBorder(borderRadius: BorderRadius.circular(20))),
  ...
  void initState() {
    super.initState();
    usuarios.addAll(Controlador.listaUsuarios);
