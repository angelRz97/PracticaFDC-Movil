...
class construirPerfil extends StatelessWidget {
  ...
  Widget construirEditarIcono(Color color) => construirCirculo(color: Colors.white, all: 3, child: construirCirculo(color: color, all: 8, child: Icon(Icons.edit, color: Colors.white, size: 20)));

  Widget construirCirculo({required Widget child, required double all, required Color color}) => ClipOval(
